...
class LoadGameData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $dodsConfigTemplate = file_get_contents(__DIR__ . '/cfg/dods.cfg');
        ...
        $cz->setType('steam');
        $cz->setSource(false);
        $cz->setConfigTemplate($czConfigTemplate);
        ...
        $dod->setType('steam');
        $dod->setSource(false);
        $dod->setConfigTemplate($dodConfigTemplate);
        ...
        $tfc->setType('steam');
        $tfc->setSource(false);
        $tfc->setConfigTemplate($tfcConfigTemplate);
